...
module.exports = {
  registerHelpers: function(hbs, app, i18n){
    ...
    hbs.registerHelper('single_video_item', function(width, height, index) {
      ...
      var videoHTML = "<video class='video-player' poster='" + videoItem.thumbnails.data[videoItem.thumbnails.data.length - 1].uri + "' controls name='media'><source src='" + videoItem.fb_source +
